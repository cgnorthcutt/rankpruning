...
# rankpruning
# Use the new package with BUG FIXES, SIMPLER CODE, GENERLIZATION to multiclass classification, and integration with SCIKIT-LEARN, PYTORCH, TENSORFLOW, and more!!! --> https://github.com/cgnorthcutt/confidentlearning/ (Check out the [classification.py](https://github.com/cgnorthcutt/confidentlearning/blob/master/confidentlearning/classification.py) file for a familiar interface).
